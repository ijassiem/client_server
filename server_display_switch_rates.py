...
if __name__ == '__main__':
                        ...
                        if i == 0:
                            ...
                            for j, val in enumerate(row):
                                if j == 0:
                                    ...
                                    row_title.addstr(i + blankc - 1, 0, val,
    ...
    while not exit:  # while exit is not True, while exit is False
        ...
        #############################################################
       # print matrix # 73 x 19

       # print len(matrix)

       # print len(matrix[0])

        np_matrix = np.asarray(matrix)  #  convert list to numpy array

        npsliced_matrix = np_matrix[0:2,:]  #  slice section of array

        print npsliced_matrix

        #print np_matrix.ndim

       # print np_matrix.shape

        #msg = pickle.dumps(matrix) # pickles matrix
        msg = pickle.dumps(npsliced_matrix)
        #msg = pickle.dumps(np_matrix)
